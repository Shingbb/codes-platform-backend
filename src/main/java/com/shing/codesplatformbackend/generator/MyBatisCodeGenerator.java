package com.shing.codesplatformbackend.generator;
...
public class MyBatisCodeGenerator {
    ...
    public static GlobalConfig createGlobalConfig() {
        ...
        globalConfig.getPackageConfig().setBasePackage("com.shing.codesplatformbackend.generator.genresult");
        ...
        globalConfig.getJavadocConfig().setAuthor("<a href=\"https://github.com/shingbb\">程序员shing</a>").setSince("");
        return globalConfig;
    }
